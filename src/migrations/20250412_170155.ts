...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  `)
  await db.run(sql`CREATE INDEX \`users_cart_items_order_idx\` ON \`users_cart_items\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`users_cart_items_parent_id_idx\` ON \`users_cart_items\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`users_cart_items_product_idx\` ON \`users_cart_items\` (\`product_id\`);`)
  ...
  `)
  await db.run(sql`CREATE INDEX \`products_variant_options_options_order_idx\` ON \`products_variant_options_options\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`products_variant_options_options_parent_id_idx\` ON \`products_variant_options_options\` (\`_parent_id\`);`)
  ...
  `)
  await db.run(sql`CREATE INDEX \`products_variants_options_order_idx\` ON \`products_variants_options\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`products_variants_options_parent_id_idx\` ON \`products_variants_options\` (\`_parent_id\`);`)
  ...
  `)
  await db.run(sql`CREATE INDEX \`_products_v_version_variant_options_options_order_idx\` ON \`_products_v_version_variant_options_options\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_products_v_version_variant_options_options_parent_id_idx\` ON \`_products_v_version_variant_options_options\` (\`_parent_id\`);`)
  ...
  `)
  await db.run(sql`CREATE INDEX \`_products_v_version_variant_options_order_idx\` ON \`_products_v_version_variant_options\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_products_v_version_variant_options_parent_id_idx\` ON \`_products_v_version_variant_options\` (\`_parent_id\`);`)
  ...
  `)
  await db.run(sql`CREATE INDEX \`_products_v_version_variants_options_order_idx\` ON \`_products_v_version_variants_options\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_products_v_version_variants_options_parent_id_idx\` ON \`_products_v_version_variants_options\` (\`_parent_id\`);`)
